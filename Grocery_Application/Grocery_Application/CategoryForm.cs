...
namespace Grocery_Application
{
    ...
    public partial class CategoryForm : Form
    {
        ...
        {
            DialogResult result = MessageBox.Show("Seçili kategoriyi silmek istiyor musunuz?", "Müşteri Ekranı", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
        ...
        {
            categoryRepo.Delete(this.selectedCategory);
        }
    }
}
